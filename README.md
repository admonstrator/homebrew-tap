...
| [`mantaray`](https://brew.admon.me/mantaray/) | TUI network topology mapper ≋ — reads STP/RSTP/MSTP/PVST+, LLDP and CDP passively, enriches over SNMP, and shows a live map, traffic, doctor findings and what-if simulations. Windows builds need [Npcap](https://npcap.com) installed separately |
...
[![The mantaray topology map: a spanning tree of seven switches with the root highlighted and live activity on the links](site/assets/mantaray/map.png)](https://brew.admon.me/mantaray/)
